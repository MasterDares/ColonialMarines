...
var/list/department_radio_keys = list(
	  ...
	  ":y" = "Bravo Squad",	"#y" = "Bravo Squad",	".y" = "Bravo Squad",
	  ":f" = "Charlie Squad",	"#f" = "Charlie Squad",	".f" = "Charlie Squad",
						...
						if(M.client)
							if(M.client.prefs)
								if(M.client.prefs.toggles & SOUND_VOICES)
									M.playsound_local(src.loc, "sound/playervoices/[src.ckey].ogg", 90)
